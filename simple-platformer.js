...
startCtx.font = '30px Roboto';
startCtx.fillStyle = '#333';
startCtx.fillText("Welcome!", startCanvas.width / 2 - 65, startCanvas.height / 3);
startCtx.font = '30px Roboto';
startCtx.fillStyle = '#333';
...
document.addEventListener('keydown', function(event) {
    if (!gameStarted && (event.key === 's' || event.key === 'S')) {
        ...
        document.getElementById('gameCanvas').style.display = 'block'; // Show the gameCanvas
...
function gameOver(message) {
    ...
    ctx.font = "20px Roboto";
    ctx.fillText("Press 'R' to Restart or 'E' to Exit", canvas.width / 2, canvas.height / 2 + 20);
...
// Level 4
{
    ...
    coins: [
        ...
        {x: 305, y: 260, radius: 10, collected: false},
...
// Level 5
{
    ...
    coins: [
        {x: 90, y: 180, radius: 10, collected: false},
...
function initializeColors() {
    ...
    playerColor = getUniqueRandomColor(usedColors);
    platformColor = getUniqueRandomColor(usedColors);
    endColor = getUniqueRandomColor(usedColors);
    enemyColor = getUniqueRandomColor(usedColors);
    obstacleColor = getUniqueRandomColor(usedColors);
}
